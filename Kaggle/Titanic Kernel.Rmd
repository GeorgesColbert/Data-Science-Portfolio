...
I recently completed my MS degree at the University of Maryland, and I 
...
First thing I want to do is take care of all NA values in the dataset. My aim is to identify which variables have NA values, and based on how manly values in the column are missing I will assume what best strategy to replace these NA values.
...
Looking through the  passenger titles, I noticed that will it would hard to seperate married man traveling alone from bachelors, I could use the "Miss" title to identify single women over 18. This could help me discern the survival differences between single women and married women. 
...
The plotted pruned tree indicated thats the most deciding feature in wether someone survived was Sex. According to this model, a female passenger who belonged to the upper or  
